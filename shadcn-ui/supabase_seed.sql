...
-- Power Platform
UPDATE activities SET name = 'Allineamento analisi requisiti', description = 'Sessioni di allineamento funzionale/tecnico sul requisito in ambito Power Platform.', base_days = 0.5, tech_category = 'POWER_PLATFORM', "group" = 'ANALYSIS', active = true WHERE code = 'PP_ANL_ALIGN';
UPDATE activities SET name = 'Creazione campi Dataverse', description = 'Definizione e creazione di nuovi campi su tabelle Dataverse, incluse proprietà base e relazioni semplici.', base_days = 0.25, tech_category = 'POWER_PLATFORM', "group" = 'DEV', active = true WHERE code = 'PP_DV_FIELD';
UPDATE activities SET name = 'Configurazione form Dataverse', description = 'Configurazione layout form, controlli e logica di base lato Dataverse.', base_days = 0.5, tech_category = 'POWER_PLATFORM', "group" = 'DEV', active = true WHERE code = 'PP_DV_FORM';
UPDATE activities SET name = 'Power Automate Flow semplice', description = 'Implementazione di un flusso Power Automate con logica lineare e poche condizioni.', base_days = 0.5, tech_category = 'POWER_PLATFORM', "group" = 'DEV', active = true WHERE code = 'PP_FLOW_SIMPLE';
UPDATE activities SET name = 'Power Automate Flow complesso', description = 'Flusso con più condizioni, rami paralleli o integrazioni esterne.', base_days = 1.0, tech_category = 'POWER_PLATFORM', "group" = 'DEV', active = true WHERE code = 'PP_FLOW_COMPLEX';
UPDATE activities SET name = 'Business Rule Dataverse', description = 'Configurazione di regole di business lato Dataverse (validazioni, calcoli, visibilità campi).', base_days = 0.25, tech_category = 'POWER_PLATFORM', "group" = 'DEV', active = true WHERE code = 'PP_BUSINESS_RULE';
UPDATE activities SET name = 'Test end-to-end Power Platform', description = 'Test end-to-end della soluzione in ambiente di test/pre-produzione.', base_days = 1.0, tech_category = 'POWER_PLATFORM', "group" = 'TEST', active = true WHERE code = 'PP_E2E_TEST';
UPDATE activities SET name = 'Supporto UAT', description = 'Supporto agli utenti per esecuzione User Acceptance Test, raccolta feedback e piccoli aggiustamenti.', base_days = 1.0, tech_category = 'POWER_PLATFORM', "group" = 'TEST', active = true WHERE code = 'PP_UAT_RUN';
UPDATE activities SET name = 'Deploy soluzione Power Platform', description = 'Preparazione e rilascio soluzione tra ambienti (dev/test/prod) con validazioni base.', base_days = 0.5, tech_category = 'POWER_PLATFORM', "group" = 'OPS', active = true WHERE code = 'PP_DEPLOY';

-- Backend
UPDATE activities SET name = 'Analisi API / backend', description = 'Analisi requisiti specifici per endpoint, logica di business e sicurezza.', base_days = 0.5, tech_category = 'BACKEND', "group" = 'ANALYSIS', active = true WHERE code = 'BE_ANL_ALIGN';
UPDATE activities SET name = 'Endpoint API semplice', description = 'Implementazione di un endpoint REST con logica lineare e CRUD standard.', base_days = 0.75, tech_category = 'BACKEND', "group" = 'DEV', active = true WHERE code = 'BE_API_SIMPLE';
UPDATE activities SET name = 'Endpoint API complesso', description = 'Endpoint con logica di business articolata, orchestrazione di più servizi o chiamate esterne.', base_days = 1.5, tech_category = 'BACKEND', "group" = 'DEV', active = true WHERE code = 'BE_API_COMPLEX';
UPDATE activities SET name = 'Migrazione schema DB', description = 'Creazione o modifica di schema DB (tabelle, indici, vincoli) e relativa migrazione.', base_days = 1.0, tech_category = 'BACKEND', "group" = 'DEV', active = true WHERE code = 'BE_DB_MIGRATION';
UPDATE activities SET name = 'Unit test backend', description = 'Implementazione di unit test per servizi o controller backend.', base_days = 0.5, tech_category = 'BACKEND', "group" = 'TEST', active = true WHERE code = 'BE_UNIT_TEST';
UPDATE activities SET name = 'Integration test backend', description = 'Test di integrazione tra componenti backend e/o servizi esterni.', base_days = 0.75, tech_category = 'BACKEND', "group" = 'TEST', active = true WHERE code = 'BE_INT_TEST';
UPDATE activities SET name = 'Logging & monitoring', description = 'Configurazione logging, metriche base e integrazione con sistema di monitoring.', base_days = 0.5, tech_category = 'BACKEND', "group" = 'OPS', active = true WHERE code = 'BE_LOGGING';
UPDATE activities SET name = 'Deploy backend', description = 'Preparazione pipeline e rilascio in ambiente di destinazione.', base_days = 0.5, tech_category = 'BACKEND', "group" = 'OPS', active = true WHERE code = 'BE_DEPLOY';

-- Frontend
UPDATE activities SET name = 'Analisi UX/UI', description = 'Analisi esigenze UX/UI per schermata o flusso frontend.', base_days = 0.5, tech_category = 'FRONTEND', "group" = 'ANALYSIS', active = true WHERE code = 'FE_ANL_UX';
UPDATE activities SET name = 'Componente UI', description = 'Implementazione di un componente UI (React o equivalente) con logica base di presentazione.', base_days = 0.5, tech_category = 'FRONTEND', "group" = 'DEV', active = true WHERE code = 'FE_UI_COMPONENT';
UPDATE activities SET name = 'Form complesso', description = 'Implementazione form con validazioni, stato complesso e integrazione API.', base_days = 1.0, tech_category = 'FRONTEND', "group" = 'DEV', active = true WHERE code = 'FE_FORM';
UPDATE activities SET name = 'Gestione stato', description = 'Configurazione e/o estensione di store globale (es. Redux, Zustand) o stato condiviso.', base_days = 0.75, tech_category = 'FRONTEND', "group" = 'DEV', active = true WHERE code = 'FE_STATE_MGMT';
UPDATE activities SET name = 'Integrazione API', description = 'Integrazione con API esistenti, gestione errori e loading.', base_days = 0.5, tech_category = 'FRONTEND', "group" = 'DEV', active = true WHERE code = 'FE_API_INTEGRATION';
UPDATE activities SET name = 'Unit test UI', description = 'Test unitari su componenti UI.', base_days = 0.5, tech_category = 'FRONTEND', "group" = 'TEST', active = true WHERE code = 'FE_UNIT_TEST';
UPDATE activities SET name = 'E2E test frontend', description = 'Test end-to-end di flussi utente critici.', base_days = 0.75, tech_category = 'FRONTEND', "group" = 'TEST', active = true WHERE code = 'FE_E2E_TEST';
UPDATE activities SET name = 'Deploy frontend', description = 'Build e pubblicazione applicazione frontend (CDN, hosting, configurazione base).', base_days = 0.5, tech_category = 'FRONTEND', "group" = 'OPS', active = true WHERE code = 'FE_DEPLOY';

-- Multi-stack
UPDATE activities SET name = 'Kickoff tecnico', description = 'Kickoff con team cross-funzionali per allineamento su scope, dipendenze e rischi.', base_days = 0.5, tech_category = 'MULTI', "group" = 'GOVERNANCE', active = true WHERE code = 'CRS_KICKOFF';
UPDATE activities SET name = 'Documentazione tecnica', description = 'Redazione o aggiornamento documentazione tecnica fondamentale per il requisito.', base_days = 0.5, tech_category = 'MULTI', "group" = 'GOVERNANCE', active = true WHERE code = 'CRS_DOC';
