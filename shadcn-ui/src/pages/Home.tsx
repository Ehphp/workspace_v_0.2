            ...
            >
              <div className="space-y-3">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-100/80 border border-blue-200/50 backdrop-blur-sm">
                  ...
                  <span className="text-xs font-medium text-blue-900">AI Estimation Workspace for Software Teams</span>
                </div>
                ...
                <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 leading-tight">
                  ...
                  <span className="block bg-gradient-to-r from-blue-600 via-indigo-600 to-fuchsia-500 bg-clip-text text-transparent">
                    From requirement to reviewable estimate
                  </span>
                </h2>

                <p className="text-sm lg:text-base text-slate-600 leading-relaxed max-w-lg">
                  Trasforma descrizioni tecniche in stime verificabili con AI, catalogo attività, driver di complessità, rischi e calcolo deterministico.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3 pt-2">
                <div className="group bg-white/60 backdrop-blur-sm rounded-lg p-3 border border-slate-200/50 hover:border-blue-300/50 transition-all duration-300">
                  ...
                  <p className="text-xs font-semibold text-slate-900">AI Artifacts</p>
                  <p className="text-[10px] text-slate-500 mt-0.5">Understanding, impact map e blueprint per analizzare meglio il requisito</p>
                </div>
                <div className="group bg-white/60 backdrop-blur-sm rounded-lg p-3 border border-slate-200/50 hover:border-indigo-300/50 transition-all duration-300">
                  ...
                  <p className="text-xs font-semibold text-slate-900">Deterministic Estimate</p>
                  <p className="text-[10px] text-slate-500 mt-0.5">Attività, driver e rischi convergono in un calcolo chiaro e replicabile</p>
                </div>
                <div className="group bg-white/60 backdrop-blur-sm rounded-lg p-3 border border-slate-200/50 hover:border-purple-300/50 transition-all duration-300">
                  ...
                  <p className="text-xs font-semibold text-slate-900">Reviewable Workflow</p>
                  <p className="text-[10px] text-slate-500 mt-0.5">Storico, confronto stime, analisi consulente e consuntivo reale</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <Card className="border-white/20 shadow-2xl ring-1 ring-white/30" style={{ backgroundColor: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(4px)' }}>
                <CardContent className="p-4">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-slate-900">AI Estimation Pipeline</h3>
                      <p className="text-[10px] text-slate-500">AI artifacts + deterministic engine</p>
                    </div>
                  </div>
                  <p className="text-xs text-slate-600 mb-3 leading-relaxed">
                    Pipeline AI + motore deterministico per produrre stime rivedibili e confrontabili.
                  </p>
                    ...
                    {[
                      {
                        ...
                        desc: 'AI sintetizza obiettivo, perimetro e complessità iniziale',
                      ...
                      },
                      {
                        ...
                        desc: 'Evidenzia le aree architetturali coinvolte',
                      ...
                      {
                        num: '3',
                        title: 'Estimation Blueprint',
                        desc: 'Scompone il requisito in componenti e lavoro tecnico',
                      ...
                      {
                        num: '4',
                        title: 'Activities, Drivers & Risks',
                        desc: 'Applica catalogo attività, driver di complessità e fattori di rischio',
                        icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />,
                        color: 'from-pink-500 to-rose-500'
                      },
                      {
                        num: '5',
                        title: 'Review, History & Actuals',
                        desc: 'Confronta versioni, revisiona la stima e misura lo scostamento sul consuntivo',
              ...
              <div className="flex items-center justify-center gap-8 pt-2">
                <div className="flex items-center gap-2 text-sm text-slate-600">
                  ...
                  <span className="font-medium">AI Artifacts</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-slate-600">
                ...
                <div className="flex items-center gap-2 text-sm text-slate-600">
                  <svg className="w-5 h-5 text-purple-500" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M4 2a2 2 0 00-2 2v11a3 3 0 106 0V4a2 2 0 00-2-2H4zm1 14a1 1 0 100-2 1 1 0 000 2zm5-14a2 2 0 00-2 2v11a3 3 0 106 0V4a2 2 0 00-2-2h-2zm1 14a1 1 0 100-2 1 1 0 000 2zm5-14a2 2 0 00-2 2v11a3 3 0 106 0V4a2 2 0 00-2-2h-2zm1 14a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd" />
                  </svg>
                  <span className="font-medium">Reviewable</span>
                </div>
              </div>
            </motion.div>
          </div>
