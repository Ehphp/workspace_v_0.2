...
export function WizardStep1({ data, onUpdate, onNext }: WizardStep1Props) {
  const canProceed = data.reqId && data.description;
    ...
    <div className="space-y-4">
      <div className="space-y-1">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h2 className="text-lg font-bold text-slate-900">Requirement Information</h2>
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-slate-500 flex items-start gap-1">
            ...
            <span>Provide context for AI to suggest relevant activities including what needs to be done, inputs/outputs, and technical constraints. <strong>A title will be automatically generated from this description.</strong></span>
          </p>
        </div>
      </div>
